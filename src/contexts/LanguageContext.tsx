...
const translations = {
  ru: {
    ...
    waitingPickupStatus: 'Ожидаем привоз',
    ...
    declaredValueLine: 'Объявленная ценность',
    waybillFeeLine: 'Плата за распечатывание накладной',
    paymentMethodLabel: 'Способ оплаты',
    payMethodCard: 'Карта',
    payMethodAssignment: 'Поручение',
    payMethodTransfer: 'Перечисление (от предприятия по неосвоенной сумме)',
    actualAmountLabel: 'Фактически принято оплаты (₸)',
    actualAmountHint: 'Укажите фактически принятую сумму оплаты, если расчет по тарифу неточен.',
    ...
    paySurcharge: 'Оплатить доплату',
    confirmSurchargePayment: 'Подтвердить получение доплаты?',
    ...
    emailNotifications: 'Login уведомления',
    ...
    registeredClients: 'Зарегистрированные лица',
    ...
    searchByNameEmail: 'Поиск по имени, login или станции...',
    ...
    individualClients: 'Физические лица',
    individualClientsDesc: 'Управление физическими лицами',
    addClient: 'Добавить клиента',
    addIndividualClient: 'Добавить физ. лицо',
    searchByNameOrContract: 'Поиск по названию, договору...',
    searchIndividual: 'Поиск по имени, логину, телефону...',
    noCorporateClients: 'Нет корпоративных клиентов.',
    noIndividualClients: 'Нет зарегистрированных физ. лиц.',
    ...
    transitFilterTitle: 'Фильтр по транзитным маршрутам',
    transitFilterSubtitle: 'Выберите станцию для просмотра сводной информации',
    transitStationLabel: 'Станция:',
    transitAllStations: 'Все станции',
    transitSendingLabel: 'Отправляем (в пути)',
    transitReceivingLabel: 'Получаем (в пути)',
    transitWeightLabel: 'Вес:',
    transitPlacesLabel: 'Мест:',
    transitStatusSent: 'Отправлено',
    transitStatusExpected: 'Ожидается',
    transitWeightSuffix: 'кг',
    transitPlacesSuffix: 'мест',
  },
  ...
  en: {
    ...
    waitingPickupStatus: 'Waiting for pickup',
    ...
    declaredValueLine: 'Declared value',
    waybillFeeLine: 'Waybill printing fee',
    paymentMethodLabel: 'Payment method',
    payMethodCard: 'Card',
    payMethodAssignment: 'Payment order',
    payMethodTransfer: 'Transfer (from enterprise unspent balance)',
    actualAmountLabel: 'Actual amount received (₸)',
    actualAmountHint: 'Enter the actual amount received if the tariff calculation is inaccurate.',
    ...
    phonePlaceholder: '+7 (___) ___-__-__',
    errorProvideNamePhone: 'Please provide name and phone',
    paySurcharge: 'Pay surcharge',
    confirmSurchargePayment: 'Confirm surcharge payment?',
    ...
    emailNotifications: 'Login Notifications',
    ...
    createButton: 'Create',
    searchByNameEmail: 'Search by name, login or station...',
    ...
    individualClientsDesc: 'Manage individual clients',
    addClient: 'Add Client',
    addIndividualClient: 'Add Individual Client',
    searchByNameOrContract: 'Search by name, contract...',
    searchIndividual: 'Search by name, login, phone...',
    noCorporateClients: 'No corporate clients.',
    noIndividualClients: 'No registered individual clients.',
    withoutName: 'Unnamed',
    activeCount: 'active',
    ...
    transitFilterTitle: 'Filter by transit routes',
    transitFilterSubtitle: 'Select a station to view summary information',
    transitStationLabel: 'Station:',
    transitAllStations: 'All stations',
    transitSendingLabel: 'Sending (in transit)',
    transitReceivingLabel: 'Receiving (in transit)',
    transitWeightLabel: 'Weight:',
    transitPlacesLabel: 'Places:',
    transitStatusSent: 'Sent',
    transitStatusExpected: 'Expected',
    transitWeightSuffix: 'kg',
    transitPlacesSuffix: 'places',
  },
  ...
  kk: {
    ...
    waitingPickupStatus: 'Әкелуін күтуде',
    ...
    declaredValueLine: 'Жарияланған құн',
    waybillFeeLine: 'Жүкқұжатын басып шығару төлемі',
    paymentMethodLabel: 'Төлем әдісі',
    payMethodCard: 'Карта',
    payMethodAssignment: 'Тапсырыс',
    payMethodTransfer: 'Аударым (кәсіпорынның игерілмеген сомасы бойынша)',
    actualAmountLabel: 'Нақты қабылданған төлем (₸)',
    actualAmountHint: 'Тариф есебі дұрыс болмаса, нақты қабылданған соманы көрсетіңіз.',
    processingPayment: 'Өңдеу...',
    ...
    phonePlaceholder: '+7 (___) ___-__-__',
    errorProvideNamePhone: 'Аты мен телефонын көрсетіңіз',
    paySurcharge: 'Доплатаны төлеу',
    confirmSurchargePayment: 'Доплата төлемін растайсыз ба?',
    ...
    emailNotifications: 'Login хабарландырулары',
    ...
    registeredClients: 'Тіркелген тұлғалар',
    employeesLabel: 'Қызметкерлер',
    ...
    createButton: 'Жасау',
    searchByNameEmail: 'Аты, login немесе станция бойынша іздеу...',
    ...
    individualClients: 'Жеке тұлғалар',
    individualClientsDesc: 'Жеке тұлғаларды басқару',
    addIndividualClient: 'Жеке тұлғаны қосу',
    searchByNameOrContract: 'Аты немесе шарт бойынша іздеу...',
    searchIndividual: 'Аты, логині, телефоны бойынша іздеу...',
    noCorporateClients: 'Корпоративті клиенттер жоқ.',
    noIndividualClients: 'Тіркелген жеке тұлғалар жоқ.',
    withoutName: 'Атаусыз',
    ...
    transitFilterTitle: 'Транзиттік бағыттар бойынша сүзгі',
    transitFilterSubtitle: 'Жиынтық ақпаратты көру үшін станцияны таңдаңыз',
    transitStationLabel: 'Станция:',
    transitAllStations: 'Барлық станциялар',
    transitSendingLabel: 'Жіберіп жатырмыз (жолда)',
    transitReceivingLabel: 'Алып жатырмыз (жолда)',
    transitWeightLabel: 'Салмағы:',
    transitPlacesLabel: 'Орындар саны:',
    transitStatusSent: 'Жіберілді',
    transitStatusExpected: 'Күтілуде',
    transitWeightSuffix: 'кг',
    transitPlacesSuffix: 'орын',
  }
};
